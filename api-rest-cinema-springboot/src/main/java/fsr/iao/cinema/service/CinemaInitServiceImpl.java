...
private VilleRepository villeRepository;
	...
	public void initVilles() {
		...
		Stream.of("Rabat","Casablanca","Oujda","Fes").forEach(nameVille->{
...
private FilmRepository filmRepository;
	...
	public void initFilms() {
		...
		Stream.of("BEHINDHER", "CASTLEVANIA", "FINALSPACE", "LOVEDEATH", "NEIGHBOR", "oxygen", "THEPERFECTDATE").forEach(nameFilm->{
			Film  film =new Film();
